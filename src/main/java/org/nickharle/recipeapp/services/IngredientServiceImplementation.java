...
public class IngredientServiceImplementation implements IngredientService {
    ...
    public IngredientServiceImplementation(IngredientToIngredientCommand ingredientToIngredientCommand,
    ...
    public IngredientCommand saveIngredientCommand(IngredientCommand command) {
        ...
        if(!recipeOptional.isPresent()){
            ...
            // This could be a save (create new ingredient) or update for an existing ingredient
            ...
            if (!savedIngredientOptional.isPresent()) {
                // caution description, amount not specified as unique
    ...
    @Override
    public void deleteById(Long recipleId, Long id) {
        log.debug("Deleting ingredient: " + recipleId + " : " + id);

        Optional<Recipe> recipeOptional = recipeRepository.findById(recipleId);
        ...
        if (recipeOptional.isPresent()) {
            ...
            log.debug("Recipe Id not found. Id: " + recipleId);
        }
